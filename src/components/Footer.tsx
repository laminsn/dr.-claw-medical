      ...
      <div className="grid md:grid-cols-4 gap-10">
        <div>
          <div className="flex items-center gap-3 mb-4">
            ...
            <span className="font-display text-lg font-bold text-background">Dr. Claw</span>
          </div>
        ...
        <div>
          ...
          <ul className="space-y-2 text-sm text-background/60">
            ...
            <li><a href="#personas" className="hover:text-background transition-colors">Use Cases</a></li>
          </ul>
        </div>
        <div>
